/**
 * Default MCP App style variables for the simulator.
 *
 * Uses CSS light-dark() so a single set of values adapts to the document's
 * color-scheme automatically. Host shells override specific entries for their
 * brand palette while falling back to these defaults.
 *
 * @see https://github.com/modelcontextprotocol/ext-apps/blob/main/specification/2026-01-26/apps.mdx#theming
 * @see /ext-apps/examples/basic-host/src/host-styles.ts
 */
