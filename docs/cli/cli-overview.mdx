...
4. **Live test** against real ChatGPT with `pnpm test:live` (see [Testing Guide](/mcp-apps-testing#live-testing))
5. **Build** for production with `sunpeak build`
6. **Start** the production server with `sunpeak start`
