...
During development, `sunpeak dev` runs an MCP server that serves simulation fixture data. For production, use `sunpeak build` followed by `sunpeak start` to run your real tool handlers — see the [Deployment Guide](/guides/deployment).
