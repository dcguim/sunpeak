...
These are useful when building your own production MCP server instead of using `runMCPServer`. See the [MCP Apps documentation](https://sunpeak.ai/docs/mcp-apps/introduction) for details.
