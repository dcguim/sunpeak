...
keywords: ["MCP Apps", "ChatGPT Apps", "React hooks", "app tools", "bidirectional tools"]
---
...
See [MCP Apps event handlers](/mcp-apps/app/event-handlers#oncalltool) for the underlying protocol.
