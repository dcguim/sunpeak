...
keywords: ["MCP Apps", "ChatGPT Apps", "React hooks", "model context", "AI context"]
---
...
See the [MCP Apps updateModelContext request](/mcp-apps/app/requests#updatemodelcontext) for protocol details.
