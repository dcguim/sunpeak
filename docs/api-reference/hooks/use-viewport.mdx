...
Container dimensions come from [`McpUiHostContext.containerDimensions`](/mcp-apps/types/core-types#mcpuihostcontext). The simulator exposes **Max Height** and **Max Width** inputs under **Container Dimensions** so you can test how your resource responds to host-enforced size constraints.
