...
<AccordionGroup>
  <Accordion title="Simulator - for local testing">
    ...
    [View Simulator API Reference](/api-reference/simulations/chatgpt-simulator)
  </Accordion>
...
<Card horizontal title="Simulator API Reference" icon="desktop" href="/api-reference/simulations/chatgpt-simulator">
