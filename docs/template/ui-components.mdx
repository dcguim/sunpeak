...
The sunpeak framework includes pre-built MCP resources in your project's `src/resources/` directory. Each resource lives in its own folder with its component, metadata, and related components.
...
Simulation files live separately in `tests/simulations/{name}/`.
